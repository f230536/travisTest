Feature: Guru add their public link
   Scenario: access code page
    ...
    Scenario: empty public link
        I clear text in element with css selector "[name='mobile_profile_code']"
        I fill in the input with selector "[name='mobile_profile_code']" with ""
        I click the element with css selector "[name='about-btn']"
            And wait 1 seconds
    ...
    Scenario: exist public link : jason
        I clear text in element with css selector "[name='mobile_profile_code']"
        I fill in the input with selector "[name='mobile_profile_code']" with "jason"
        I click the element with css selector "[name='about-btn']"
            And wait 1 seconds
        I verify that the element with css selector ".loading-container" has a class "active"
        ## I verify that the element with css selector "[name='code_checkmark']" has a class "checkmark-add-active"
    ...
    Scenario: changeback original public link : jason1
        I clear text in element with css selector "[name='mobile_profile_code']"
        I fill in the input with selector "[name='mobile_profile_code']" with "jason1"
        I click the element with css selector "[name='about-btn']"
            And wait 1 seconds
